<h1>XLA Runtime</h1>
<p>XLA runtime is a set of libraries that support execution of XLA programs
...
defines the FFI for compiled programs to call into user-defined callbacks.</p>
<p>If you squint and look at XLA as a programming language like Objective-C, then
...
we do not want to codegen directly on top of <code>pthreads</code> library.</p>