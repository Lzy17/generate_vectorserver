<p>The files in this directory are compiled multiple times for different CPU vector instruction
 ...
 capabilities. Much of this is done via preprocessor guards in vec256_qint.h.</p>
<p>The considerations for code written in this directory include:
  ...
  - <strong>Make sure different variants of the code (AVX, AVX2) are tested!</strong>
    There are build variants that do things like have NO AVX and NO AVX2 in
    CI. Make sure they work!</p>