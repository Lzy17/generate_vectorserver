<p>This folder contains the c10 dispatcher. This dispatcher is a single point
...
be replaced.</p>
<p>This folder contains the following files:
...
- KernelFunction.h: The core interface (i.e. function pointer) for calling a kernel</p>